...
import { getLocalStorageItem, removeLocalStorageItem, setLocalStorageItem } from "@/app/common/LocalStorage";
...
if (response.status === 200 && data.token) {
  ...
  let microchipTime = Number(getLocalStorageItem("microchip_number_time") || 0);
  let transferTime = Number(getLocalStorageItem("transfer_microchip_time") || 0);
  ...
  if (microchipTime > transferTime && encryptedMicrochip) {
    router.push(
      `/pet-owners/update-pet-microchip?microchip=${encodeURIComponent(encryptedMicrochip)}`
    );
    return;
  }
                  ...
                  <Form>
                    <div className="row">
                      ...
                      <div className="col-lg-12 col-md-12 mb-4 text-center">
                        <Link href="/user-register/pet_owner">
                          Need an account?
                        </Link>
                      </div>
                    </div>
